...
directoryLoad='Z:\MSc Mathematical Engineering\Third Semester\Fluid Labs\CFD\CFD1\main_simulation\main.phi';
directorySave='Z:\MSc Mathematical Engineering\Third Semester\Fluid Labs\CFD\CFD1\main_simulation\main.mat';
...
variables={'P1' 'V1' 'W1' 'DWDY'}; %to let process all the variables write 'all' (pay attention to time required)
